...
def generate_traffic_dataset():
    ...
    # Bước 2: Gom các node cách nhau <= 25 mét thành 1 Node trung tâm
    # Nếu vòng xoay chỗ bạn lớn hơn, có thể tăng số tolerance này lên (VD: 30, 40)
    ...
    # Xử lý Nodes (Bây giờ 100% Node là Ngã tư)
    ...
    print("Hoàn tất! Đã loại bỏ các điểm Local, tập trung hoàn toàn vào cấu trúc mạng lưới đường.")
