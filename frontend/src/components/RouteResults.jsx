  ...
  return (
    <div
      className={`transition-all duration-500 ease-out overflow-hidden ${
        hasSearched ? "max-h-[600px] opacity-100 mt-6" : "max-h-0 opacity-0 mt-0"
      }`}
    >
      {/* Visualizer Controls */}
      <div className="mb-4">
        <h2 className="text-sm font-semibold text-gray-900 mb-2">Visualizer</h2>
      ...
      <div className="mb-4 rounded-lg border border-blue-100 bg-blue-50 p-3">
        <div className="flex items-start gap-2">
          ...
          <div>
            <p className="text-xs font-semibold text-blue-900 mb-1">Why this route?</p>
            <p className="text-xs text-blue-800 leading-relaxed">
              This path minimizes total {optimization.toLowerCase()} cost by favoring
              fewer intersections and avoiding congested segments, based on the{" "}
              {algorithm} traversal.
            </p>
          </div>
        </div>
