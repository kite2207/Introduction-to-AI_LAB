...
The project is prepared by Group 11 for Lab 1 of Introduction to Artificial
...
5 (gridlock).
\item \code{road\_type}: the road classification, such as \code{primary} or
\code{secondary}.
...
\begin{equation}h_{mixed}(n)=\frac{d_H(n,t)+10d_H(n,t)/16.67}{2}\end{equation}
